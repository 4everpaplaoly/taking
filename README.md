...
Taking은 사용자의 약 복용 기록을 관리하고,
일주일 단위로 복약 패턴을 분석하여 AI 주간 건강 리포트를 제공하는 안드로이드 애플리케이션입니다.
...
📌 실제 실행 화면은 리포지토리 내 스크린샷 또는 시연 영상 참고
